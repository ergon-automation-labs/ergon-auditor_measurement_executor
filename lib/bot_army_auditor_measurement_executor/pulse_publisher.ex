defmodule BotArmyAuditorMeasurementExecutor.PulsePublisher do
  @moduledoc """
  Periodic health publisher for Measurement Executor Bot.
  ...
  2. **`bot.auditor_measurement_executor.pulse`** — richer metrics every 30 minutes (lower NATS volume).
  ...
  @service_name "auditor_measurement_executor"
  @envelope_source "bot_army_auditor_measurement_executor"
  ...
  @impl true
  def init(_opts) do
    Logger.info("[PulsePublisher] Starting Measurement Executor Bot pulse publisher")
