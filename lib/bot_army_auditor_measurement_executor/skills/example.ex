defmodule BotArmyAuditorMeasurementExecutor.Skills.Example do
  @moduledoc """
  Example skill for Measurement Executor Bot.
  ...
  1. NATS message arrives on trigger subject: `bot.bot_army_auditor_measurement_executor.command.example`
  ...
  5. Result published to response subject: `bot.bot_army_auditor_measurement_executor.response.<request_id>`
  ...
  1. Rename: `lib/bot_army_auditor_measurement_executor/skills/your_skill.ex`
  ...
  def nats_triggers do
    ...
    [
      "bot.bot_army_auditor_measurement_executor.command.example"
    ]
  end
