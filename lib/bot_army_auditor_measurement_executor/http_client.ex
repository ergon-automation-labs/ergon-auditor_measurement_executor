defmodule BotArmyAuditorMeasurementExecutor.HTTPClient do
  @moduledoc """
  ...
  Pass http_client as an option in init:
      def init(opts) do
        http_client = Keyword.get(opts, :http_client, BotArmyAuditorMeasurementExecutor.HTTPClient.Req)
...
defmodule BotArmyAuditorMeasurementExecutor.HTTPClient.Req do
  @moduledoc """
  Real HTTP client implementation using the Req library.
  """

  @behaviour BotArmyAuditorMeasurementExecutor.HTTPClient
