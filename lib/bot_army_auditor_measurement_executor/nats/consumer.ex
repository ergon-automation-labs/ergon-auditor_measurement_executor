defmodule BotArmyAuditorMeasurementExecutor.NATS.Consumer do
  @moduledoc """
  NATS message consumer for auditor_measurement_executor.
  ...
  def handle_continue(:connect, state) do
    case GenServer.call(BotArmyLibraryRuntime.NATS.Connection, :get_connection, 5000) do
      {:ok, conn} ->
        ...
        BotArmyLibraryRuntime.Registry.register("auditor_measurement_executor", @subjects, @version)
