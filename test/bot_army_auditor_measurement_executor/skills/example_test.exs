defmodule BotArmyAuditorMeasurementExecutor.Skills.ExampleTest do
  @moduledoc """
  ...
  alias BotArmyAuditorMeasurementExecutor.Skills.Example
  ...
  describe "nats_triggers/0" do
    test "returns list of trigger subjects" do
      ...
      assert "bot.bot_army_auditor_measurement_executor.command.example" in triggers
    end
  end
